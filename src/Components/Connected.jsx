...
const Connected = (props) => {
    return (
        <div className="connected-container">
            ...
            <p className="connected-account">Remaining Time: {props.remainingTime} seconds <span id="live">LIVE</span></p>
            { props.showButton ? (
            ...
            <div class="card-collection">
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p class="card-text">Sense of humor</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-description">
                        <h2 class="card-title">Nauryzbai Tasbulat</h2>
                        <p class="card-text">19 y.o.</p>
                        <p class="card-text">Poker master</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p class="card-text">19 y.o.</p>
                        <p class="card-text">Girls' dream</p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-description">
                        ...
                        <p class="card-text">19 y.o.</p>
                        <p class="card-text">Big musician</p>
                    </div>
                </div>
            </div>
        </div>
